...
$THETA
 ...
 (0, 10) ; V2(4) 3.34 L/kg
 (0, 500) ; V3(5) 0.651 L/kg
 (0, 10) ; Q (6) 0.12 L/h/kg
...
$TABLE ID TIME AMT DV MDV IPRED CWRES IWRES BQL ROUTE               ONEHEADER NOPRINT FILE = sdtab6.txt
$TABLE ID CL V2 V3 Q KA F1 FF FA D2 ALAG2 DOSE                      ONEHEADER NOPRINT NOAPPEND FILE = patab6.txt
