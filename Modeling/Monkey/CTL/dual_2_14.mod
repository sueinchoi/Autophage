...
$TABLE ID TIME AMT DV MDV IPRED CWRES IWRES BQL ROUTE               ONEHEADER NOPRINT FILE = sdtab2_14.txt
$TABLE ID CL V2 V3 Q KA F1 FF FA D2 ALAG2 DOSE                      ONEHEADER NOPRINT NOAPPEND FILE = patab2_14.txt
