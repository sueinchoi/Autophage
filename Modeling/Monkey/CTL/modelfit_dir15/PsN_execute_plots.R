...
#Created 2020-11-26 at 15:34

rplots.level <- 1
xpose.runno <- '2_11'
toolname <- 'execute'
pdf.filename <- paste0('PsN_',toolname,'_plots.pdf')
pdf.title <- 'execute diagnostic plots run 2_11'
working.directory<-'C:/Users/cnr/Documents/GitHub/Autophage/Modeling/Monkey/CTL/modelfit_dir15/'
raw.results.file <- 'raw_results_dual10.csv'
model.directory<-'C:/Users/cnr/Documents/GitHub/Autophage/Modeling/Monkey/CTL/'
model.filename<-'dual10.mod'
