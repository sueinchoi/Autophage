...
#Created 2020-11-25 at 12:08

rplots.level <- 1
xpose.runno <- '2_12'
toolname <- 'execute'
pdf.filename <- paste0('PsN_',toolname,'_plots.pdf')
pdf.title <- 'execute diagnostic plots run 2_12'
working.directory<-'C:\\Users\\admin\\Documents\\GitHub\\Autophage\\Modeling\\Monkey\\CTL\\modelfit_dir8\\'
