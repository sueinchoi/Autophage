...
$TABLE ID TIME AMT DV MDV IPRED CWRES IWRES BQL   ONEHEADER NOPRINT FILE = sdtab004.txt
$TABLE ID CL V1 V2 Q  DOSE                      ONEHEADER NOPRINT NOAPPEND FILE = patab004.txt
